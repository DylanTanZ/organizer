 ...
 * Updated by liu woon kit on 23/5/2017
 */
public class SqlAccess {
    private final String DEFAULT_USERNAME = "user";
    private final String DEFAULT_PASSWORD= "123";
    private final String CONNECTION_FAIL = "CONNECTION FAIL ERROR " + ERROR_CODE;
    ...
    public void openConnection(){
        try{
            ...
            System.out.println(CONNECTION_FAIL + e.getMessage());
        }
    }
    ...
    public string eseses(int ERROR_CODE) {
        switch(ERROR_CODE) {
            case(0): {
